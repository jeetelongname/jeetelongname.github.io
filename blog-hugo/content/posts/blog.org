...
** Moving to wayland! Login shell lambasting
:PROPERTIES:
...
rut I was in. and inspration from the [[https://github.com/doomemacs/doomemacs][doom env command for some inspiration]]
